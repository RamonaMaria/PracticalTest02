...
public class CommunicationThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("https://www.wunderground.com/weather/ro/bucharest");
            List<NameValuePair> params = new ArrayList<>();
            params.add(new BasicNameValuePair("Post", city));
...
//            org.jsoup.nodes.Element element = document.select("div.temp").first();
//            String temperat = element.text();
//
//
//            Log.v(Constants.TAG, "------------------------------------------------" + temperat);
//
//
//
